...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.0.109"\n    ],\n    "debugPort": 60032,\n    "initialLaunchType": "local",\n    "servePort": 60033,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"test","spaceId":"d175cc26-9048-4b89-b393-2bbbc0a77475","clientSecret":"lNXQSq/M6W+syUeOWE+oQw==","endpoint":"https://api.bspapp.com"}]');
let _ = "";
try {
  _ = "__UNI__870202E";
} catch (e) {
